...
---Docs: https://defold.com/ref/stable/sys/?q=sys.get_config#sys.get_config
---
...
---@return string value config value as a string. default_value if the config key does not exist
