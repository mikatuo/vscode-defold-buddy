...
---@return integer value config value as an integer. default_value if the config key does not exist. nil if no default value was supplied.
...
---@return number value config value as an number. default_value if the config key does not exist. nil if no default value was supplied.
